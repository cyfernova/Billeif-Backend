...
resource "aws_dynamodb_table" "refresh_tokens" {
  name         = "${local.resource_name_prefix}-refresh-tokens"
  billing_mode = "PAY_PER_REQUEST"
  hash_key     = "token"
...
resource "aws_dynamodb_table" "password_reset_tokens" {
  name         = "${local.resource_name_prefix}-password-reset-tokens"
  billing_mode = "PAY_PER_REQUEST"
  hash_key     = "token"
...
resource "aws_dynamodb_table" "mfa_codes" {
  name         = "${local.resource_name_prefix}-mfa-codes"
  billing_mode = "PAY_PER_REQUEST"
  hash_key     = "user_id"
  range_key    = "code"
...
resource "aws_dynamodb_table" "customers_cache" {
  name         = "${local.resource_name_prefix}-customers-cache"
  billing_mode = "PAY_PER_REQUEST"
...
resource "aws_dynamodb_table" "vendors_cache" {
  name         = "${local.resource_name_prefix}-vendors-cache"
  billing_mode = "PAY_PER_REQUEST"
  hash_key     = "vendor_id"
...
resource "aws_dynamodb_table" "products_cache" {
  name         = "${local.resource_name_prefix}-products-cache"
  billing_mode = "PAY_PER_REQUEST"
  hash_key     = "product_id"
...
resource "aws_dynamodb_table" "invoices_cache" {
  name         = "${local.resource_name_prefix}-invoices-cache"
  billing_mode = "PAY_PER_REQUEST"
  hash_key     = "invoice_id"
...
resource "aws_dynamodb_table" "invoice_sequences" {
  name         = "${local.resource_name_prefix}-invoice-sequences"
  billing_mode = "PAY_PER_REQUEST"
...
resource "aws_dynamodb_table" "ledger_cache" {
  name         = "${local.resource_name_prefix}-ledger-cache"
  billing_mode = "PAY_PER_REQUEST"
...
resource "aws_dynamodb_table" "payments_cache" {
  name         = "${local.resource_name_prefix}-payments-cache"
  billing_mode = "PAY_PER_REQUEST"
  hash_key     = "payment_id"
