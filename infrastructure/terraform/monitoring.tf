    ...
    widgets = [
      {
        ...
        properties = {
          ...
          metrics = [
            ["AWS/ECS", "CPUUtilization", "ClusterName", aws_ecs_cluster.main.name, "ServiceName", aws_ecs_service.main.name, { color = "#ff7f0e" }],
            [".", "MemoryUtilization", ".", ".", ".", ".", { color = "#2ca02c" }]
          ]
          stat   = "Average"
          period = 60
        }
      },
      {
        ...
        properties = {
          ...
          region = var.aws_region
          metrics = [
            ["AWS/ApplicationELB", "RequestCount", "LoadBalancer", aws_lb.main.arn_suffix, { stat = "Sum", color = "#1f77b4" }]
          ]
          period = 60
        }
      },
      ...
      },
      {
        ...
        properties = {
          ...
          region = var.aws_region
          metrics = [
            ["AWS/RDS", "CPUUtilization", "DBInstanceIdentifier", aws_db_instance.main.id, { color = "#d62728" }],
            [".", "DatabaseConnections", ".", ".", { yAxis = "right", color = "#9467bd" }]
          ]
          period = 60
        }
      },
      ...
      },
      {
        ...
        properties = {
          ...
          region = var.aws_region
          metrics = [
            ["AWS/ElastiCache", "CPUUtilization", "CacheClusterId", aws_elasticache_cluster.main.cluster_id, { color = "#17becf" }],
            [".", "CurrConnections", ".", ".", { yAxis = "right", color = "#bcbd22" }]
          ]
          period = 60
        }
      }
