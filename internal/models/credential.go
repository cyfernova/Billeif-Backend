...
type PaymentCredential struct {
	...
	EncryptedData      *string    `gorm:"type:text" json:"encrypted_data,omitempty" validate:"omitempty"`
	...
	CredentialTokens []CredentialToken `gorm:"foreignKey:CredentialID" json:"credential_tokens,omitempty"`
}
...
type CredentialToken struct {
	...
	Token            string    `gorm:"not null;unique;index" json:"token" validate:"required"`
